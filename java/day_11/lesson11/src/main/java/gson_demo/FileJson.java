...
public class FileJson {
    public static void main(String[] args) {
        ...
        Student student2 = new Student(1, "Bùi Hiên", 25, "hien@techmaster.vn");

        // Ghi đối tượng student vào file "student.json"
        convertObjectToJsonFile("student.json", student2);
...
//        students.add(new Student(4, "Phan D", 26, "d@gmail.com"));
        ...
        convertObjectToJsonFile("list-student.json", students2);
    }
